...
public class CustomDateConvtor extends PropertyEditorSupport{
	...
	public static SimpleDateFormat[] format ={ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS"),new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"),new SimpleDateFormat("yyyy-MM-dd")};
	 ...
	 */
	public CustomDateConvtor(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public CustomDateConvtor(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
	...
	public String getAsText() {
		...
		if(dateFormat == null){
			...
			s = (value != null ? this.dateFormat.format(value) : "");
		}
		return s;
	}
