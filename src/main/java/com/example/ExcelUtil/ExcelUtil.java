...
//		logger.info("开始生成excel:"+t1);
//		
//		// 设置导出文件的名称，如果功能未设置，则取为实体的名称
//		Object o = model.get("fileName");
//		String filename = null;
//		if (StringUtils.isEmpty(o)) {
//			filename = getNowDateStr();
//		} else {
//			filename = o.toString();
//		}
//		filename = filename + ".xlsx";
//		//设置下载时客户端Excel的名称（中文标题）
...
//		ouputStream.flush();
//		ouputStream.close();
//		TimeIntervalHelper.getInterval("生成excel完成:", "生成excel完成耗时", t1);
//	}
//
//}
