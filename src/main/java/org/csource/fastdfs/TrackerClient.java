...
*/
	...
	*/
	...
	{
		logger.debug("tracker_group: {}", this.tracker_group);
		if (null == this.tracker_group) {
			this.tracker_group = ClientGlobal.g_tracker_group;
		}
		if (null == this.tracker_group) {
			InetSocketAddress[] tracker_servers = new InetSocketAddress[1];
			tracker_servers[0] = new InetSocketAddress("123.56.237.72", 22122);
			this.tracker_group = new TrackerGroup(tracker_servers);
		}
