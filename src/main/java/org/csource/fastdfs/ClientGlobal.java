...
import com.example.common.WeixinProperties;
...
{
	static final Logger log = LoggerFactory.getLogger(ClientGlobal.class);
...
//  		iniReader = new IniFileReader(conf_filename);
			...
			g_connect_timeout = WeixinProperties.connect_timeout;
  		...
  		g_network_timeout = WeixinProperties.network_timeout;
  		...
  		g_charset = WeixinProperties.charset;
  		if (g_charset == null || g_charset.length() == 0)
  		{
  			g_charset = "ISO8859-1";
  		}
  	
  		szTrackerServers = new String[]{WeixinProperties.tracker_server};
  		//log.info("-----------------------track_server:"+tracker_server);
  		...
  		g_tracker_http_port = WeixinProperties.tracker_http_port;
  		g_anti_steal_token = WeixinProperties.anti_steal_token;
  		if (g_anti_steal_token)
  		{
//  			g_secret_key = iniReader.getStrValue("http.secret_key");
  			g_secret_key = WeixinProperties.secret_key;
  		}
	}
